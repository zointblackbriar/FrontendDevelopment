...
var buttonWidth = 4990 ,buttonHeight = 900;
...
button()
    ...
    {
        console.log("Deploy");
        //console.log("which class: ", whichObject);
        //sample json objects
        //dataObj[locationsObj].source.push("Service1");
        //dataObj[locationsObj].source.push("Service2");
        //dataObj[locationsObj].target.push("Image1");
        //dataObj[locationsObj].target.push("Image2");
        console.log("Result source:", dataObj[locationsObj].source);
        console.log("Result target:", dataObj[locationsObj].target);
    })();
...
//    console.log("our json object is: %O", jsonObject);
